...
class Deque_as_array_tester:public Tester< Deque_as_array > {
	using Tester< Deque_as_array >::object;
	using Tester< Deque_as_array >::command;

	public:
		Deque_as_array_tester( Deque_as_array *obj = 0 ):Tester< Deque_as_array >( obj ) {
			// empty
		}
...
template <typename Object>
void Deque_as_array_tester<Object>::process() {
	if ( command == "size" ) {
		...
		Object expected_tail;

		std::cin >> expected_tail;

		Object actual_tail = object->tail();
		...
		Object actual_dequeued_element = object->dequeue_head();
		...
		Object actual_dequeued_element = object->dequeue_tail();
